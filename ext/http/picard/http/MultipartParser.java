...
// line 1 "parser/MultipartParser.rl"
package picard.http;
...
// line 184 "parser/MultipartParser.rl"
...
// line 34 "ext/http/picard/http/MultipartParser.java"
...
// line 201 "parser/MultipartParser.rl"

    public MultipartParser(ByteBuffer boundary, MultipartParserCallback callback) {

// line 175 "ext/http/picard/http/MultipartParser.java"
	{
	cs = multipart_start;
	}

// line 204 "parser/MultipartParser.rl"
...
// line 234 "parser/MultipartParser.rl"

// line 213 "ext/http/picard/http/MultipartParser.java"
	{
	int _klen;
	int _trans = 0;
	int _acts;
...
case 1:
		...
		while ( _nacts-- > 0 )
	{
			...
			{
	case 0:
// line 15 "parser/MultipartParser.rl"
	{
	...
	break;
	case 1:
// line 106 "parser/MultipartParser.rl"
	{
            int curr  = 0;
	...
	break;
	case 2:
// line 157 "parser/MultipartParser.rl"
	{
            parsingBody = true;
	...
	break;
	case 3:
// line 166 "parser/MultipartParser.rl"
	{
	...
	break;
	case 4:
// line 171 "parser/MultipartParser.rl"
	{
	...
	break;
	case 5:
// line 177 "parser/MultipartParser.rl"
	{
            if (true) {
	...
	break;
	case 6:
// line 7 "parser/common.rl"
	{
      headerNameChunks = new ChunkedValue(buf, p);
  }
	break;
	case 7:
// line 11 "parser/common.rl"
	{
...
// line 41 "parser/common.rl"
	...
	break;
// line 532 "ext/http/picard/http/MultipartParser.java"
			}
		}
	}
...
// line 177 "parser/MultipartParser.rl"
	...
	break;
// line 561 "ext/http/picard/http/MultipartParser.java"
		}
	}
	}
...
// line 235 "parser/MultipartParser.rl"
